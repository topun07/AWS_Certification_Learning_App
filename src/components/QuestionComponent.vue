      ...
      <footer class="mt-24 2xl:mt-32 border-t border-slate-200 bg-slate-50/50 pt-12 pb-8 2xl:pt-20 2xl:pb-12 rounded-t-[3rem] 2xl:rounded-t-[4rem]">
        <div class="max-w-4xl 2xl:max-w-6xl mx-auto px-4 md:px-8 text-center flex flex-col items-center">
          ...
          <div class="flex flex-col sm:flex-row w-full gap-4 2xl:gap-8 justify-center">
            ...
            <a href="https://www.linkedin.com/company/117764274" target="_blank" rel="noopener noreferrer" class="inline-flex justify-center items-center gap-2 2xl:gap-5 bg-white text-[#0077B5] hover:bg-[#0077B5] hover:text-white px-4 py-3 2xl:px-10 2xl:py-6 rounded-2xl 2xl:rounded-3xl font-black text-xs md:text-sm 2xl:text-xl uppercase tracking-widest transition-all border border-slate-200 hover:border-[#0077B5] shadow-sm hover:shadow-md group flex-1 min-w-0">
              <svg class="w-5 h-5 2xl:w-8 2xl:h-8 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
              </svg>
              <span>LinkedIn</span>
            </a>

            <a href="https://www.youtube.com/@KnowledgeForgeAcademy" target="_blank" rel="noopener noreferrer" class="inline-flex justify-center items-center gap-2 2xl:gap-5 bg-white text-[#FF0000] hover:bg-[#FF0000] hover:text-white px-4 py-3 2xl:px-10 2xl:py-6 rounded-2xl 2xl:rounded-3xl font-black text-xs md:text-sm 2xl:text-xl uppercase tracking-widest transition-all border border-slate-200 hover:border-[#FF0000] shadow-sm hover:shadow-md group flex-1 min-w-0">
              <svg class="w-5 h-5 2xl:w-8 2xl:h-8 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
